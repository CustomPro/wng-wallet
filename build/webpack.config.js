...
const {__DEV__, __PROD__, __TEST__, __ANDROID__} = config.globals
...
// Bundle Output
// ------------------------------------
let bundlePath = paths.base(config.dir_dist)
if (__ANDROID__) { bundlePath = paths.base(config.dir_android) }
